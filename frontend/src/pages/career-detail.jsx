    ...
    const requirements = [
        {
            ...
            description: "Nắm vững HTML, CSS, JavaScript và các framework như React, Vue.js hoặc Angular"
        },
        {
            title: "Kinh nghiệm làm việc",
            description: "Có ít nhất 1-3 năm kinh nghiệm trong phát triển giao diện người dùng"
        },
        {
            title: "Ngôn ngữ",
        ...
        {
            title: "Kỹ năng mềm",
            description: "Khả năng làm việc nhóm, giao tiếp tốt, quản lý thời gian hiệu quả"
        }
    ];
    ...
    const skills = [
        {
            ...
            items: ["HTML5/CSS3", "JavaScript/ES6+", "React.js", "Redux", "REST APIs", "Git"]
        },
        {
            category: "Công cụ phát triển",
            items: ["VS Code", "Chrome DevTools", "npm/yarn", "Webpack", "ESLint"]
        },
        {
            category: "Kỹ năng mềm",
            items: ["Làm việc nhóm", "Quản lý thời gian", "Giải quyết vấn đề", "Tư duy logic"]
        }
    ];
                ...
                <div className="banner-content">
                    ...
                    <div className="career-meta">
                        ...
                        <div className="meta-item">
                            ...
                            <span className="value">{careerData.experience}</span>
                        </div>
                        <div className="meta-item">
                            <span className="label">Cơ hội việc làm:</span>
                            <span className="value high">{careerData.opportunity}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="content">
                <main className="main-content">
                    <section id="overview" className="section">
                        ...
                        <p>Mô tả chi tiết về nghề nghiệp và vai trò trong công việc...</p>
                        ...
                        <div className="career-stats">
                            ...
                            <div className="stat-card">
                                ...
                                <div className="stat-label">Tăng trưởng ngành</div>
                            </div>
                        </div>
                    </section>
                    ...
                    <div className="info-card">
                        ...
                        <div className="info-list">
                            <div className="info-item">
                                ...
                                <span className="info-value">{careerData.field}</span>
                            </div>
                            <div className="info-item">
                                <span className="info-label">Môi trường</span>
                                <span className="info-value">{careerData.environment}</span>
                            </div>
                            <div className="info-item">
                                <span className="info-label">Thời gian</span>
                                <span className="info-value">{careerData.workTime}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="info-card">
                        ...
                        <div className="related-majors">
                            <Link to="/major/1" className="related-item">
                                <span className="major-name">Công nghệ thông tin</span>
                                <span className="arrow">→</span>
                            </Link>
                            <Link to="/major/2" className="related-item">
                                <span className="major-name">Kỹ thuật phần mềm</span>
                                <span className="arrow">→</span>
                            </Link>
                            <Link to="/major/3" className="related-item">
                                <span className="major-name">Khoa học máy tính</span>
                                <span className="arrow">→</span>
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="info-card">
                        ...
                        <div className="similar-careers">
                            <Link to="/career/2" className="similar-item">
                                <span className="career-name">Backend Developer</span>
                                <span className="salary">20-40M</span>
                            </Link>
                            <Link to="/career/3" className="similar-item">
                                <span className="career-name">Full-stack Developer</span>
                                <span className="salary">25-45M</span>
                            </Link>
                            <Link to="/career/4" className="similar-item">
                                <span className="career-name">UI/UX Designer</span>
