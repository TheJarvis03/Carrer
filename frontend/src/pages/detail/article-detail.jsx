        ...
        <div className="article-detail-page">
            <article className="article-content">
                <header className="article-header">
                    ...
                    <h1>
                        Ngày hội tư vấn tuyển sinh 2024 tại Đại học Quốc gia Hà
                        Nội
                    </h1>
                ...
                <div className="article-body">
                    ...
                    <div className="article-text">
                        <p>
                            Ngày hội tư vấn tuyển sinh năm 2024 sẽ diễn ra tại
                            Đại học Quốc gia Hà Nội với sự tham gia của hơn 100
                            trường đại học, cao đẳng trên cả nước...
                        </p>

                        <h2>Thời gian và địa điểm</h2>
                        <p>
                            Sự kiện sẽ diễn ra từ 8h00-17h00, ngày 20/04/2024
                            tại:
                        </p>
                        <ul>
                    ...
                    <div className="related-list">
                        <Link to="/article/2" className="related-item">
                            ...
                            <div className="related-info">
                                <h4>
                                    Hướng dẫn đăng ký xét tuyển đại học 2024
                                </h4>
