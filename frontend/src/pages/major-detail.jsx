            ...
            <div className="academic-major-content">
                ...
                <main className="major-main">
                    <section className="major-description">
                        ...
                        <p>Ngành Công nghệ thông tin (CNTT) là một trong những ngành học được đánh giá là có tiềm năng phát triển mạnh mẽ trong thời đại số. Chương trình đào tạo tập trung vào các kiến thức về lập trình, phát triển phần mềm, trí tuệ nhân tạo, và an ninh mạng.</p>
                    ...
                    <section className="career-prospects">
                        ...
                        <div className="prospects-grid">
                            <div className="prospect-card">
                                ...
                                <p>Phát triển ứng dụng web, mobile và desktop</p>
                            ...
                            <div className="prospect-card">
                                ...
                                <p>Quản lý và tối ưu hóa quy trình phát triển</p>
