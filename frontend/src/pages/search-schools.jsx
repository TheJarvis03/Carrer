    ...
    return (
        <div className="ssh-page">
            <section className="search-header">
                ...
                <p>Tra cứu thông tin chi tiết về các trường đại học, cao đẳng</p>
                    ...
                    <div className="ssh-results-panel">
                        ...
                        <div className="ssh-schools-grid">
                            {Array(6).fill(0).map((_, i) => (
                                <Link to={`/school/${i + 1}`} key={i} className="ssh-school-card">
                                    <div className="ssh-school-image">
                                        <img src={`/images/school-${i+1}.jpg`} alt="School" />
                                        <div className="ssh-school-type">Công lập</div>
                                    </div>
                                    <div className="ssh-school-content">
                                        <div className="ssh-school-main">
                                            <h3 className="ssh-school-name">Trường Đại học {i + 1}</h3>
                                            <div className="ssh-school-info">
                                                ...
                                                <div className="ssh-info-item">
                                                    ...
                                                    <span>12,000 sinh viên</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="ssh-school-details">
                                            <div className="ssh-stat-item">
                                                <div className="ssh-stat-label">Điểm chuẩn</div>
                                                <div className="ssh-stat-value">23.5-27.5</div>
                                                <div className="ssh-stat-range">Năm 2023</div>
                                            </div>
                                            <div className="ssh-stat-item">
                                                <div className="ssh-stat-label">Học phí/năm</div>
                                                <div className="ssh-stat-value">15-20tr</div>
                                            </div>
                                            <div className="ssh-stat-item">
                                                <div className="ssh-stat-label">Tỷ lệ có việc làm</div>
                                                <div className="ssh-stat-value">92%</div>
                                                <div className="ssh-stat-note">Sau 12 tháng</div>
                                            </div>
                                        </div>
                                    </div>
                                </Link>
