        ...
        <div className="sd-content-container">
          <section id="overview" className="sd-content-section">
            ...
            <div className="sd-section-content">
              ...
              <div className="sd-overview-description">
                <p>
                  Trường Đại học Bách khoa Hà Nội (tên tiếng Anh: Hanoi
                  University of Science and Technology - HUST) là trường đại học
                  đầu ngành về kỹ thuật và công nghệ tại Việt Nam. Với hơn 65
                  năm xây dựng và phát triển, Trường ĐHBK Hà Nội đã trở thành
                  một địa chỉ đào tạo uy tín, cung cấp nguồn nhân lực chất lượng
                  cao cho xã hội.
                </p>
                <a
          ...
          <section id="scores" className="sd-content-section">
            ...
            <div className="sd-section-content">
              <div className="sd-section-description">
                <p>
                  Điểm chuẩn xét tuyển đại học năm 2023 theo phương thức xét
          ...
          <section id="quota" className="sd-content-section">
            ...
            <div className="sd-section-content">
              <div className="sd-section-description">
                <p>
                  Thông tin chi tiết chỉ tiêu tuyển sinh năm 2024 và phương thức
                  xét tuyển:
                </p>
              ...
              <table className="sd-score-table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td data-label="Tỷ lệ">
                      70% THPT, 20% Học bạ, 10% Xét tuyển thẳng
                    </td>
            ...
            <div className="sd-section-content">
              <div className="sd-facilities-grid">
                <div className="sd-facility-item">
                  ...
                  <p>
                    Thư viện với hơn 200,000 đầu sách, tài liệu điện tử và không
                    gian học tập hiện đại.
                  </p>
                </div>
                <div className="sd-facility-item">
                  <h3>Khu Ký túc xá</h3>
                  <p>
                    Hệ thống ký túc xá hiện đại có sức chứa hơn 10,000 sinh viên
