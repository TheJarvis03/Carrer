            ...
            <section className="sd-school-banner">
                <div className="sd-banner-content">
                    <div className="sd-school-logo">
                        <img src="/school-logo.png" alt="Logo trường" style={{width: '100%', height: '100%', objectFit: 'contain'}} />
                    </div>
            ...
            <nav className="sd-school-nav">
                <div className="sd-nav-container">
                    <ul>
                        ...
                        <li><a href="#scores">Điểm chuẩn</a></li>
                        <li><a href="#quota">Chỉ tiêu tuyển sinh</a></li>
            ...
            <main className="sd-main-content">
                <div className="sd-content-container">
                        ...
                        <div className="sd-section-content">
                            <div className="sd-overview-stats">
                                <div className="sd-stat-box">
                                    ...
                                    <span className="sd-stat-label">Ngành đào tạo</span>
                                </div>
                                <div className="sd-stat-box">
                                    <span className="sd-stat-number">35k+</span>
                                    <span className="sd-stat-label">Sinh viên</span>
                                </div>
                                <div className="sd-stat-box">
                                    <span className="sd-stat-number">95%</span>
                                    <span className="sd-stat-label">Tỷ lệ việc làm</span>
                                </div>
                            </div>
                            <div className="sd-overview-description">
                                <p>Trường Đại học Bách khoa Hà Nội (tên tiếng Anh: Hanoi University of Science and Technology - HUST) là trường đại học đầu ngành về kỹ thuật và công nghệ tại Việt Nam. Với hơn 65 năm xây dựng và phát triển, Trường ĐHBK Hà Nội đã trở thành một địa chỉ đào tạo uy tín, cung cấp nguồn nhân lực chất lượng cao cho xã hội.</p>
                    ...
                    <section id="scores" className="sd-content-section">
                        ...
                        <div className="sd-section-content">
                            <div className="sd-section-description">
                                <p>Điểm chuẩn xét tuyển đại học năm 2023 theo phương thức xét điểm thi THPT Quốc gia:</p>
                            </div>
                            <table className="sd-score-table">
                                ...
                                <tbody>
                                    <tr>
                                        <td data-label="Ngành">Khoa học máy tính</td>
                                        <td data-label="Điểm chuẩn">27.50</td>
                                        <td data-label="Tổ hợp môn">A00, A01</td>
                                    </tr>
                                    <tr>
                                        <td data-label="Ngành">Kỹ thuật phần mềm</td>
                                        <td data-label="Điểm chuẩn">28.75</td>
                                        <td data-label="Tổ hợp môn">A00, A01, D01</td>
                                    </tr>
                                    <tr>
                                        <td data-label="Ngành">Hệ thống thông tin</td>
                                        <td data-label="Điểm chuẩn">27.80</td>
                                        <td data-label="Tổ hợp môn">A00, A01, D01</td>
                                    </tr>
                                    <tr>
                                        <td data-label="Ngành">An toàn thông tin</td>
                                        <td data-label="Điểm chuẩn">27.90</td>
                                        <td data-label="Tổ hợp môn">A00, A01</td>
                                    </tr>
                                    <tr>
                                        <td data-label="Ngành">Kỹ thuật điện</td>
                                        <td data-label="Điểm chuẩn">26.50</td>
                                        <td data-label="Tổ hợp môn">A00, A01</td>
                                    </tr>
                                    <tr>
                                        <td data-label="Ngành">Kỹ thuật điện tử</td>
                                        <td data-label="Điểm chuẩn">26.75</td>
                                        <td data-label="Tổ hợp môn">A00, A01</td>
                                    </tr>
                                    <tr>
                                        <td data-label="Ngành">Kỹ thuật điều khiển và tự động hóa</td>
                                        <td data-label="Điểm chuẩn">27.15</td>
                                        <td data-label="Tổ hợp môn">A00, A01</td>
                                    </tr>
                                    <tr>
                                        <td data-label="Ngành">Kỹ thuật cơ khí</td>
                    ...
                    <section id="quota" className="sd-content-section">
                        <h2 className="sd-section-title">Chỉ tiêu tuyển sinh</h2>
                        <div className="sd-section-content">
                            <div className="sd-section-description">
                                <p>Thông tin chi tiết chỉ tiêu tuyển sinh năm 2024 và phương thức xét tuyển:</p>
                                <ul className="sd-admission-methods">
                                    <li>Xét tuyển thẳng và ưu tiên xét tuyển</li>
                            ...
                            <table className="sd-score-table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td data-label="Tỷ lệ">70% THPT, 20% Học bạ, 10% Xét tuyển thẳng</td>
                        ...
                        <div className="sd-section-content">
                            <div className="sd-facilities-grid">
                                <div className="sd-facility-item">
                                    ...
                                    <p>Thư viện với hơn 200,000 đầu sách, tài liệu điện tử và không gian học tập hiện đại.</p>
                                </div>
                                <div className="sd-facility-item">
                                    <h3>Khu Ký túc xá</h3>
                                    <p>Hệ thống ký túc xá hiện đại có sức chứa hơn 10,000 sinh viên với đầy đủ tiện nghi.</p>
                                </div>
                            </div>
                        </div>
                    </section>
